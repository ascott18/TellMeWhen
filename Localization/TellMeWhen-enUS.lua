...
L["ICONMENU_SHOWACTVTNBORDER"] = "Show activation border"
L["ICONMENU_SHOWACTVTNBORDER_DESC"] = "Check this to draw the sparkly yellow border on this icon whenever the spell it is tracking has one on your action bars."
...
L["TEXTLAYOUTS_AURA_CASTER"] = "Aura Caster"
...
L["CONDITIONPANEL_ADDON_RESTRICTION"] = "Addon Restriction Active"
L["CONDITIONPANEL_ADDON_RESTRICTION_DESC"] = "Checks if any of the selected addon restriction types are currently active."
L["CONDITIONPANEL_ADDON_RESTRICTION_COMBAT"] = "Combat"
L["CONDITIONPANEL_ADDON_RESTRICTION_COMBAT_DESC"] = "The player is actively affecting combat."
L["CONDITIONPANEL_ADDON_RESTRICTION_ENCOUNTER"] = "Encounter"
L["CONDITIONPANEL_ADDON_RESTRICTION_ENCOUNTER_DESC"] = "The player is actively participating in an instance encounter."
L["CONDITIONPANEL_ADDON_RESTRICTION_CHALLENGE"] = "Challenge Mode"
L["CONDITIONPANEL_ADDON_RESTRICTION_CHALLENGE_DESC"] = "The player is in an active and incomplete challenge mode or mythic keystone dungeon."
L["CONDITIONPANEL_ADDON_RESTRICTION_PVP"] = "PvP Match"
L["CONDITIONPANEL_ADDON_RESTRICTION_PVP_DESC"] = "The player is in an active and incomplete PvP match."
L["CONDITIONPANEL_ADDON_RESTRICTION_MAP"] = "Map"
L["CONDITIONPANEL_ADDON_RESTRICTION_MAP_DESC"] = "The player is on a map that applies addon restrictions."
L["CONDITIONPANEL_ADDON_RESTRICTION_CHAT"] = "Chat"
L["CONDITIONPANEL_ADDON_RESTRICTION_CHAT_DESC"] = "The player is in a state where addon chat communications are restricted."
...
L["ITEMTYPEEQUIPPED"] = "Equipped item type"
