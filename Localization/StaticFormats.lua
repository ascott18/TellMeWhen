...
L["ICONMENU_ICD_DESC"] 	  			  = L["ICONMENU_ICD_DESC"]		 		 :format(Spell(1499), Spell(82731), Spell(1122), L["ICONMENU_ICDTYPE"])
...
L["ICONMENU_CHOOSENAME_ORITEMSLOT"]   = L["ICONMENU_CHOOSENAME_ORITEMSLOT"]	 :format(INVSLOT_FIRST_EQUIPPED, INVSLOT_LAST_EQUIPPED)
