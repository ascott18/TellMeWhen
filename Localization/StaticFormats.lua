...
L["CLEU_RANGE_DAMAGE_MULTISTRIKE"]              = L["CLEU_RANGE_DAMAGE_MULTISTRIKE"]                :format(L["CLEU_RANGE_DAMAGE"])
L["CLEU_SWING_DAMAGE_MULTISTRIKE_DESC"]         = L["CLEU_SWING_DAMAGE_MULTISTRIKE_DESC"]           :format(L["CLEU_SWING_DAMAGE"])
L["CLEU_SPELL_DAMAGE_MULTISTRIKE_DESC"]         = L["CLEU_SPELL_DAMAGE_MULTISTRIKE_DESC"]           :format(L["CLEU_SPELL_DAMAGE"])
L["CLEU_SPELL_PERIODIC_DAMAGE_MULTISTRIKE_DESC"]= L["CLEU_SPELL_PERIODIC_DAMAGE_MULTISTRIKE_DESC"]  :format(L["CLEU_SPELL_PERIODIC_DAMAGE"])
L["CLEU_SPELL_HEAL_MULTISTRIKE_DESC"]           = L["CLEU_SPELL_HEAL_MULTISTRIKE_DESC"]             :format(L["CLEU_SPELL_HEAL"])
L["CLEU_SPELL_PERIODIC_HEAL_MULTISTRIKE_DESC"]  = L["CLEU_SPELL_PERIODIC_HEAL_MULTISTRIKE_DESC"]    :format(L["CLEU_SPELL_PERIODIC_HEAL"])
