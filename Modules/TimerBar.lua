...
--[[
local TimerBar_BarView = TMW:NewClass("IconModule_TimerBar_BarView", "IconModule_TimerBar")
function TimerBar_BarView:SetupForIcon(sourceIcon)
	error("IconModule_TimerBar_BarView says, \"I'm not implemented yet!\"")
end]]