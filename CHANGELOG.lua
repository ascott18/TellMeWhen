...
[==[* Text Layouts are now defined on an account-wide basis instead of beind defined for individual profiles.]==],
[==[]==],
[==[* All references from one icon or group to another in TellMeWhen are now tracked by a unique ID that is assigned to an icon that will stay with it no matter where it is moved or exported to.]==],
[==[** This includes:]==],
[==[*** DogTags]==],
[==[*** Meta icons]==],
...
[==[** The consequence of this is that you can now, for example, import/export meta icons and the icons checked by the meta icons separately and they will automatically find eachother once they are all imported (as long as these export strings were created with TMW v7.0.0+)]==],
[==[** Existing DogTags that reference other icons/groups by ID cannot be updated automatically - you will need to change these yourself.]==],
[==[]==],
[==[* The duration of Diminishing Returns is now 17 seconds by default, down from 18 seconds, and this value is now customizable in TMW's main options.]==],
...
[==[]==],
[==[* Bug Fixes:]==],
[==[** IconModule_AlphaAlpha.lua:84: attempt to index local "IconModule_Alpha" (a nil value)]==],
...
[==[** Fixed: ComponentsIconModulesIconModule_AlphaAlpha.lua:145 attempt to perform arithmetic on field "actualAlphaAtLastChange" (a nil value)]==],
[==[** Fixed: IconType_unitcooldownunitcooldown.lua:270 attempt to index local "NameHash" (a boolean value)]==],
...
[==[** Fixed: {{{CoreConditionsCategoriesPlayerAttributes.lua:60: attempt to call upvalue "GetInstanceDifficulty" (a nil value) }}}]==],
...
[==[* Bug Fixes:]==],
[==[** Fixed error InterfaceAddOnsTellMeWhenTellMeWhen.lua:155: table index is nil]==],
[==[]==],
[==[===v6.1.0===]==],
...
[==[** Fixed the error stemming from ComponentsCoreSpellsClassSpellCache.lua:215 ()? running while in combat.]==],
[==[]==],
[==[===v6.0.4===]==],
...
[==[** Fix attempted for GroupModule_GroupPositionConfig.lua line 47: attempt to index local 'Module' (a nil value)]==],
[==[** IncreasedStats should now properly include Legacy of the Emperor]==],
[==[** Fixed ComponentsIconTypesIconType_unitcooldownunitcooldown.lua:317 attempt to index local 'NameHash' (a boolean value)]==],
[==[** Fixed ComponentsIconModulesIconModule_PowerBarPowerBar.lua:128 attempt to index local 'colorinfo' (a nil value)]==],
[==[** Fixed ComponentsIconModulesIconModule_AlphaAlpha.lua:96 attempt to compare nil with number]==],
...
[==[** CoreConditionsCategoriesBuffsDebuffs.lua:56 attempt to index global 'strlowerCache' (a nil value)]==],
[==[]==],
[==[===v6.0.1===]==],
...
[==[** (r462) AceDB-3.0-22.lua:104 in function <Ace3AceDB-3.0AceDB-3.0.lua:100 table index is NaN (MAYBE)]==],
...
[==[** (r281) TellMeWhenTypesdr.lua:182 table index is nil]==],
...
[==[** (r253) TellMeWhen_OptionsTellMeWhen_Options.lua:2246: attempt to index global "current" (a nil value)]==],
...
[==[* Bug Fixes:]==],
[==[** (r242) 1x AceConfigDialog-3.0AceConfigDialog-3.0-54.lua:803: attempt to index field "rootframe" (a nil value)]==],
...
[==[** (r149) TellMeWhenTellMeWhen-r147.lua:1136: attempt to index local "icon" (a nil value)]==],
[==[]==],
[==[===v4.4.3===]==],
