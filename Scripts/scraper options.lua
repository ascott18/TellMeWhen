...
local ADDON_NAME = "TellMeWhen_Options"
...
local localization = ""
for key, v in pairs(localizedKeys) do
	localization = string.format("%s\nL[\"%s\"] = %s", localization, key, key)
...
io.open(PATH_TO_ADDONS .. "TellMeWhen/Scripts/" .. ADDON_NAME.. "_USEDLOCALE.lua", "w"):write(keep or localization)
