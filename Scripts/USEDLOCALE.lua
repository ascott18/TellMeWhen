...
L["RESOURCES"] = true
L["UIPANEL_UPDATEINTERVAL"] = true
L["UIPANEL_FONT_SIZE_DESC"] = true
L["SOUNDERROR3"] = true
L["ICONMENU_MULTISTATECD"] = true
L["NEWVERSION"] = true
L["ICONMENU_SHOWCBARN"] = true
L["LEFT"] = true
L["ICONMENU_APPENDCONDT"] = true
L["UIPANEL_TREE_DESC"] = true
L["ICONMENU_UNITSTOWATCH"] = true
L["UIPANEL_TOOLTIP_ROWS"] = true
L["SUGGESTIONS"] = true
L["SUG_MSCDONBARS"] = true
L["ICONMENU_ALPHA"] = true
L["GROUPCONDITIONS"] = true
L["ICONMENU_ALWAYS"] = true
L["CONDITIONPANEL_ANDOR"] = true
L["CONDITIONPANEL_GREATER"] = true
L["CONDITIONPANEL_MOUNTED"] = true
L["ICONMENU_PRESENT"] = true
L["UIPANEL_TOOLTIP_COLUMNS"] = true
L["CONDITIONPANEL_INSTANCETYPE"] = true
L["UIPANEL_ROWS"] = true
L["ASPECT"] = true
L["TOPLEFT"] = true
L["MP5"] = true
L["UIPANEL_ENABLEGROUP"] = true
L["ANN_SUB_CHANNEL"] = true
L["UIPANEL_ALLRESET"] = true
L["CONDITIONALPHA"] = true
L["ICONMENU_SORTASC"] = true
L["CONDITIONORMETA_CHECKINGINVALID"] = true
L["ANN_SHOWICON"] = true
L["SOUND_SOUNDTOPLAY"] = true
L["MESSAGERECIEVE"] = true
L["LOCKED"] = true
L["UIPANEL_PRIMARYSPEC"] = true
L["SENDSUCCESSFUL"] = true
L["ICONMENU_BOTH"] = true
L["BOTTOMLEFT"] = true
L["SPELLCRIT"] = true
L["UIPANEL_FONT_OUTLINE"] = true
L["SUG_TOOLTIPTITLE"] = true
L["CONDITIONPANEL_ALIVE"] = true
L["UIPANEL_DRAWEDGE"] = true
L["UIPANEL_BARIGNOREGCD_DESC"] = true
L["UIPANEL_TOOLTIP_UPDATEINTERVAL"] = true
L["ICONMENU_COOLDOWNTYPE"] = true
L["ICONMENU_ICDUNUSABLE"] = true
L["BOTTOMRIGHT"] = true
L["ICONMENU_MUSHROOMS"] = true
L["TOSTRING_DESC"] = true
L["UIPANEL_GROUPRESET"] = true
L["MELEECRIT"] = true
L["AIR"] = true
L["OUTLINE_THIN"] = true
...
L["ENABLINGOPT"] = true
L["UIPANEL_SPEC"] = true
L["CHECKORDER_ICONDESC"] = true
L["ICONMENU_SPELLCAST_DESC"] = true
L["ICONMENU_REACTIVE"] = true
L["SOUND_EVENT_ONSHOW_DESC"] = true
L["TOP"] = true
L["GROUPADDONSETTINGS"] = true
L["ANN_TAB"] = true
L["ICONMENU_MOUSEOVERTARGET"] = true
L["SUG_BUFFEQUIVS"] = true
L["CONDITIONS"] = true
L["ICONMENU_ICDUSABLE"] = true
L["UIPANEL_SCALE"] = true
L["UIPANEL_LOCK"] = true
L["SUG_DEBUFFEQUIVS"] = true
L["TOTEMS"] = true
L["ICONMENU_MOUSEOVER"] = true
L["ICONMENU_FRIEND"] = true
L["CONDITIONPANEL_CLASSIFICATION"] = true
L["UIPANEL_POINT"] = true
L["CMD_OPTIONS"] = true
L["ICONMENU_CHOOSENAME"] = true
L["SUG_MISC"] = true
L["ICONMENU_BUFF"] = true
L["EARTH"] = true
L["CONDITIONPANEL_UNIT"] = true
L["UIPANEL_COLOR_OOR"] = true
L["FIRE"] = true
L["ICONMENU_DEBUFF"] = true
L["ICONMENU_MOVEHERE"] = true
L["ICONMENU_WPNENCHANTTYPE"] = true
L["ICONMENU_CHECKNEXT"] = true
L["CONDITIONPANEL_LESSEQUAL"] = true
L["CONDITIONPANEL_COMBO"] = true
L["ICONMENU_CHOOSENAME_CNDTIC"] = true
L["SOUND_TAB"] = true
L["MAIN"] = true
L["IMPORTCOPY"] = true
L["TOPLAYER_DESC"] = true
L["UIPANEL_ADDGROUP"] = true
L["ICONMENU_OFFS"] = true
L["SUG_PLAYERAURAS"] = true
L["RECEIVED"] = true
L["CHOOSENAME_DIALOG_ICD"] = true
L["SOUND_EVENT_ONHIDE_DESC"] = true
L["ASCENDING"] = true
L["ICONMENU_ONLYEQPPD"] = true
L["fICON"] = true
L["ICONMENU_ONLYINTERRUPTIBLE"] = true
L["CONDITIONPANEL_TYPE"] = true
L["ICONMENU_ONLYBAGS"] = true
L["CHOOSENAME_DIALOG"] = true
L["UIPANEL_FONT_XOFFS"] = true
L["ALLOWCOMM"] = true
L["ICONMENU_SWAPWITH"] = true
L["UIPANEL_FONT_OVERRIDELBF"] = true
L["UIPANEL_TOOLTIP_ALLRESET"] = true
L["ICONMENU_CASTS"] = true
L["ICONMENU_SHOWTIMER"] = true
L["ICONMENU_PETTARGET"] = true
L["OUTLINE_NO"] = true
L["LDB_TOOLTIP2"] = true
L["ANN_CHANTOUSE"] = true
L["CACHINGSPEED"] = true
L["SORTBY"] = true
L["WATER"] = true
L["ICONMENU_WPNENCHANT"] = true
L["DESCENDING"] = true
L["UIPANEL_FONT_OVERRIDELBF_DESC"] = true
L["ICONMENU_SHOWTIMERTEXT"] = true
L["SOUND_EVENT_ONFINISH_DESC"] = true
L["ICONMENU_UNUSABLE"] = true
L["FALSE"] = true
L["UIPANEL_LOCK_DESC"] = true
L["SOUND_EVENT_ONSTART"] = true
L["LDB_TOOLTIP1"] = true
L["ICONMENU_USABLE"] = true
L["ICONMENU_FOCUSTARGET"] = true
L["SUN"] = true
L["UIPANEL_POSITION"] = true
L["ICONMENU_SPELLCAST"] = true
L["UIPANEL_ICONSPACING_DESC"] = true
L["UIPANEL_BARTEXTURE"] = true
L["UIPANEL_LEVEL"] = true
L["CACHING"] = true
L["PARENTHESISWARNING"] = true
L["UIPANEL_FONT_SIZE"] = true
L["SOUND_EVENT_ONHIDE"] = true
L["ICONMENU_SHOWPBARN"] = true
L["NOTINRANGE"] = true
L["UIPANEL_DRAWEDGE_DESC"] = true
L["CONDITIONPANEL_VALUEN"] = true
L["UIPANEL_FONT_DESC"] = true
L["CONDITIONPANEL_RUNES_DESC"] = true
L["ICONMENU_COOLDOWNCHECK"] = true
L["SOUND_EVENT_ONFINISH"] = true
L["ICONMENU_REACTIVE_DESC"] = true
L["LOADINGOPT"] = true
L["UIPANEL_ADDGROUP_DESC"] = true
L["EXPORT_LOLTITLE"] = true
L["GROUPICON"] = true
...
L["ICONMENU_ICD"] = true
L["ICONMENU_COPYHERE"] = true
L["ECLIPSE_DIRECTION"] = true
L["CONDITIONPANEL_GREATEREQUAL"] = true
L["ICONMENU_UNITCOOLDOWN"] = true
L["UIPANEL_FONT_OUTLINE_DESC"] = true
L["CONDITIONPANEL_NOTEQUAL"] = true
L["PLAYERSTATS"] = true
L["RANGEDHASTE"] = true
L["ACTIVE"] = true
L["ICONMENU_ONLYMINE"] = true
L["ICONMENU_UNITCOOLDOWN_DESC"] = true
L["SORTBYNONE"] = true
L["ANN_STICKY"] = true
L["UIPANEL_RELATIVETO_DESC"] = true
L["STANCE"] = true
L["MAINTANK"] = true
L["UIPANEL_CLOCKIGNOREGCD_DESC"] = true
L["CONDITIONPANEL_ECLIPSE_DESC"] = true
L["CONDITIONPANEL_POWER_DESC"] = true
L["ICONMENU_USEACTIVATIONOVERLAY"] = true
L["CONDITIONPANEL_VEHICLE"] = true
L["ICONFUNCTIONS"] = true
L["NONE"] = true
L["ITEMCOOLDOWN"] = true
L["CONDITIONPANEL_EXISTS"] = true
L["SUG_CASTEQUIVS"] = true
L["ICONMENU_SPELL"] = true
L["ITEMEQUIPPED"] = true
L["UIPANEL_CLOCKIGNOREGCD"] = true
L["REACTIVECNDT_DESC"] = true
L["CASTERFORM"] = true
L["ICONMENU_ICDBDE"] = true
L["UIPANEL_DELGROUP"] = true
L["UIPANEL_COLOR_ABSENT_DESC"] = true
L["ICONMENU_CASTSHOWWHEN"] = true
L["ICONMENU_ICD_DESC"] = true
L["ICONMENU_INVERTBARS"] = true
L["DISABLED"] = true
L["UIPANEL_EFFTHRESHOLD"] = true
L["UIPANEL_EFFTHRESHOLD_DESC"] = true
L["CONDITIONPANEL_RESTING"] = true
L["RUNSPEED"] = true
L["UIPANEL_FONT"] = true
L["PARENTHESISWARNING2"] = true
L["ICONTOCHECK"] = true
L["SOUND_EVENT_ONSTART_DESC"] = true
L["CONDITIONPANEL_NAME"] = true
L["UIPANEL_BARIGNOREGCD"] = true
L["SOUND_EVENTS"] = true
L["CONDITIONPANEL_LEVEL"] = true
L["ICONMENU_META_DESC"] = true
L["UIPANEL_COLOR_PRESENT"] = true
L["LOADERROR"] = true
L["ICONMENU_ICDAURA_DESC"] = true
L["UIPANEL_ICONSPACING"] = true
L["ICONMENU_TARGETTARGET"] = true
L["ICON_TOOLTIP1"] = true
L["ICONMENU_BUFFTYPE"] = true
L["UIPANEL_COLOR_ABSENT"] = true
L["CONDITIONPANEL_GROUPTYPE"] = true
L["RANGEDCRIT"] = true
L["TRUE"] = true
L["CONDITIONPANEL_CLASS"] = true
L["ICONMENU_BUFFDEBUFF"] = true
L["UIPANEL_SUBTEXT2"] = true
L["SPEED_DESC"] = true
L["MOON"] = true
L["SUG_NPCAURAS"] = true
...
L["PRESENCE"] = true
L["SHAPESHIFT"] = true
L["UIPANEL_COLOR_STARTED_DESC"] = true
L["UIPANEL_TOOLTIP_PRIMARYSPEC"] = true
L["CONDITIONPANEL_OR"] = true
L["UIPANEL_COLOR_COMPLETE"] = true
L["UIPANEL_COLOR_OOR_DESC"] = true
L["MELEEHASTE"] = true
L["CONDITIONPANEL_OPERATOR"] = true
L["SPEED"] = true
L["OUTLINE_THICK"] = true
L["UIPANEL_COLOR_PRESENT_DESC"] = true
L["UIPANEL_TREE"] = true
L["CONDITIONPANEL_ITEMRANGE"] = true
L["UIPANEL_LOCKUNLOCK"] = true
L["UIPANEL_WARNINVALIDS"] = true
L["CURRENCIES"] = true
L["ICONMENU_ICDTYPE"] = true
L["ICONMENU_CNDTIC"] = true
L["ICONMENU_ITEM"] = true
L["ICONMENU_VEHICLE"] = true
L["MESSAGERECIEVE_SHORT"] = true
L["INRANGE"] = true
L["ICONMENU_CNDTIC_DESC"] = true
L["LUACONDITION_DESC"] = true
L["ICONMENU_SORTDESC"] = true
L["AURA"] = true
L["ICONMENU_HIDEUNEQUIPPED"] = true
L["UIPANEL_COLOR_DESC"] = true
L["ICONMENU_DISPEL"] = true
L["COPYPOS"] = true
L["UIPANEL_TOOLTIP_GROUPRESET"] = true
L["CONDITIONPANEL_MANAUSABLE"] = true
L["ICONMENU_ENABLE"] = true
L["SOUND_CUSTOM"] = true
L["UIPANEL_COLOR_STARTED"] = true
L["CONDITIONPANEL_AND"] = true
L["UIPANEL_COLUMNS"] = true
L["UNNAMED"] = true
L["UIPANEL_COLORS"] = true
L["CHECKORDER"] = true
L["FROMSTRING"] = true
L["UIPANEL_COLOR_OOM_DESC"] = true
L["fGROUP"] = true
L["CHOOSENAME_DIALOG_CNDTIC"] = true
L["NUMAURAS"] = true
L["UIPANEL_FONT_YOFFS"] = true
L["ICONMENU_TOTEM"] = true
L["NUMAURAS_DESC"] = true
L["ICONMENU_COOLDOWN"] = true
L["MUSHROOM"] = true
L["UIPANEL_GROUPNAME"] = true
L["DURATIONPANEL_TITLE"] = true
L["ICONMENU_RANGECHECK"] = true
L["SOUNDERROR1"] = true
L["UIPANEL_COLOR_COMPLETE_DESC"] = true
L["UIPANEL_RELATIVEPOINT"] = true
L["CONDITIONPANEL_COMBAT"] = true
L["ICONMENU_MANACHECK"] = true
L["TOSTRING"] = true
L["SUG_PLAYERSPELLS"] = true
L["CENTER"] = true
L["UIPANEL_RELATIVETO"] = true
L["ICONMENU_TYPE"] = true
L["SUG_CLASSSPELLS"] = true
L["ICONMENU_IGNORERUNES"] = true
L["SOUND_USEMASTER_DESC"] = true
L["BOTTOM"] = true
L["ICONMENU_META"] = true
L["ICONMENU_ADDMETA"] = true
L["TOPRIGHT"] = true
L["CHECKORDER_GROUPDESC"] = true
L["UIPANEL_DELGROUP_DESC"] = true
L["UIPANEL_TOOLTIP_ENABLEGROUP"] = true
L["UIPANEL_TOOLTIP_SECONDARYSPEC"] = true
L["SUG_DISPELTYPES"] = true
L["ICONMENU_SHOWWHEN"] = true
L["UIPANEL_SECONDARYSPEC"] = true
L["UIPANEL_MAINOPT"] = true
L["ICONMENU_ONLYSEEN"] = true
L["ICONALPHAPANEL_FAKEHIDDEN"] = true
L["STACKSPANEL_TITLE"] = true
L["FROMSTRING_DESC"] = true
L["CONDITIONPANEL_SPELLRANGE"] = true
L["CONDITIONPANEL_ALTPOWER_DESC"] = true
L["SOUND_EVENT_ONSHOW"] = true
L["ICONMENU_ABSENT"] = true
L["UIPANEL_GROUPS"] = true
L["ICONMENU_MULTISTATECD_DESC"] = true
L["UIPANEL_COLOR_OOM"] = true
L["CONDITIONPANEL_POWER"] = true
L["ANN_EDITBOX"] = true
L["SOUND_USEMASTER"] = true
...
for k, v in ipairs(t) do
	if not FOUND[v] and not string.find(v, "[a-z]") then
		print(v)
	end
end