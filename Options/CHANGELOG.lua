...
[==[]==],
[==[* Many icon types are now able to control an entire group with the data that they harvest when set on the first icon in a group.]==],
[==[]==],
...
[==[]==],
[==[* In the wake of the recent distribution of malicious scripts to WeakAuras users, TellMeWhen now warns you when importing executable Lua code so that you can't be tricked into importing scripts you don't know about.]==],
[==[]==],
[==[====Bug Fixes====]==],
