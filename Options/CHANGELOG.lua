...
* The spell cache used by TellMeWhen_Options is no longer saved to disk. Many improvements have been made that allow it to be recomputed each time the addon is loaded. This should improve login and logout times by a decent amount.
