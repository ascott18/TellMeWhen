...
[==[]==],
[==[* In the wake of the recent distribution of malicious scripts to WeakAuras users, TellMeWhen now warns you when you import executable Lua code.]==],
...
[==[*** A consequence of this fix is that if you are enter a unit like "boss 1", this will no longer work. You need to enter "boss1", which has always been the proper unitID.]==],
[==[]==],
[==[===v6.2.6===]==],
[==[* Bug Fixes:]==],
