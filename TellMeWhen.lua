...
TELLMEWHEN_VERSIONNUMBER = 80036 -- NEVER DECREASE THIS NUMBER (duh?).  IT IS ALSO ONLY INTERNAL (for versioning of)

TELLMEWHEN_FORCECHANGELOG = 80036 -- if the user hasn't seen the changelog until at least this version, show it to them.
