...
TELLMEWHEN_VERSIONNUMBER = 71027 -- NEVER DECREASE THIS NUMBER (duh?).  IT IS ALSO ONLY INTERNAL (for versioning of)

TELLMEWHEN_FORCECHANGELOG = 71024 -- if the user hasn't seen the changelog until at least this version, show it to them.
...
TMW.BE = {
	...
	buffs = {
		...
		SpeedBoosts			= "54861;121557;_2983;_61684;68992;108843;65081;118922;108212;2379;58875;133278;85499;96268;137452;111400;116841;119085;7840;5118;13159;2645;_77761",
	...
	for category, b in pairs(TMW.OldBE) do
		for equiv, str in pairs(b) do
			...
			for _, spell in pairs(t) do
				if type(spell) == "number" and not TMW_GetSpellInfo(spell) then
					TMW:Debug("Invalid spellID found: %s (%s - %s)!",
