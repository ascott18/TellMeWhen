...
Type:RegisterConfigPanel_ConstructorFunc(100, "TellMeWhen_ValueSettings", function(self)
	...
	local types = {
	    ...
	    [SPELL_POWER_MANA or Enum.PowerType.Mana] = MANA,
		[SPELL_POWER_RAGE or Enum.PowerType.Rage] = RAGE,
		[SPELL_POWER_ENERGY or Enum.PowerType.Energy] = ENERGY,
		[SPELL_POWER_COMBO_POINTS or Enum.PowerType.ComboPoints] = COMBO_POINTS,
		[SPELL_POWER_FOCUS or Enum.PowerType.Focus] = FOCUS,
		-- [SPELL_POWER_RUNES] = RUNES,
		[SPELL_POWER_RUNIC_POWER or Enum.PowerType.RunicPower] = RUNIC_POWER,
		[SPELL_POWER_SOUL_SHARDS or Enum.PowerType.SoulShards] = SOUL_SHARDS,
		[SPELL_POWER_HOLY_POWER or Enum.PowerType.HolyPower] = HOLY_POWER,
		[SPELL_POWER_CHI or Enum.PowerType.Chi] = CHI_POWER;
		[SPELL_POWER_MAELSTROM or Enum.PowerType.Maelstrom] = MAELSTROM_POWER,
		[SPELL_POWER_ARCANE_CHARGES or Enum.PowerType.ArcaneCharges] = ARCANE_CHARGES_POWER,
		[SPELL_POWER_LUNAR_POWER or Enum.PowerType.LunarPower] = LUNAR_POWER,
		[SPELL_POWER_INSANITY or Enum.PowerType.Insanity] = INSANITY_POWER,
		[SPELL_POWER_FURY or Enum.PowerType.Fury] = FURY,
		[SPELL_POWER_PAIN or Enum.PowerType.Pain] = PAIN,
	    [SPELL_POWER_ALTERNATE_POWER or Enum.PowerType.Alternate] = L["CONDITIONPANEL_ALTPOWER"],
	}
