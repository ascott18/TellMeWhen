...
--- A {{{TMW.Classes.ConditionObjectConstructor}}} aids in the creation of a {{{TMW.Classes.ConditionObject}}}
-- 
...
--- Loads the parent and the Condition settings that will be used to construct a {{{TMW.Classes.ConditionObject}}}.
-- @param parent [table] The parent of the {{{TMW.Classes.ConditionObject}}} that will be created.
-- @param Conditions [table] The condition settings that will be used to create a {{{TMW.Classes.ConditionObject}}}.
...
-- This copy of settings will be used to :Construct() the {{{TMW.Classes.ConditionObject}}} instead of the originally loaded conditions.
