...
ConditionCategory:RegisterCondition(3,	 "MOUNTED", {
	...
	events = function(ConditionObject, c)
		return
			ConditionObject:GenerateNormalEventString("PLAYER_MOUNT_DISPLAY_CHANGED"),
...
ConditionCategory:RegisterCondition(13.1, "PETMODE2", {
	...
	bitFlags = {
		...
		[1] = TMW.ClassicExpansionAtMost(LE_EXPANSION_WRATH_OF_THE_LICH_KING) and PET_MODE_AGRESSIVE or PET_MODE_ASSIST,
		[2] = PET_MODE_DEFENSIVE,
		[3] = PET_MODE_PASSIVE
	},

	unit = false,
	icon = TMW.ClassicExpansionAtMost(LE_EXPANSION_WRATH_OF_THE_LICH_KING) and PET_PASSIVE_TEXTURE or PET_ASSIST_TEXTURE,
	tcoords = CNDT.COMMON.standardtcoords,
