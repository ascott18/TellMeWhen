...
ConditionCategory:RegisterCondition(12,	 "TIMEOFDAY", {
	...
	unit = false,
	icon = TMW.ClassicExpansionAtLeast(LE_EXPANSION_MISTS_OF_PANDARIA) and "Interface\\Icons\\Ability_Racial_TimeIsMoney" or "Interface\\Icons\\inv_misc_pocketwatch_02",
	tcoords = CNDT.COMMON.standardtcoords,
	Env = {
