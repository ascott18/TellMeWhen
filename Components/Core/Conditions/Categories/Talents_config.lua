...
if GetGlyphSocketInfo then
	...
	elseif TMW.ClassicExpansionAtLeast(LE_EXPANSION_CATACLYSM) then
	...
	elseif TMW.ClassicExpansionAtLeast(LE_EXPANSION_WRATH_OF_THE_LICH_KING) then
		...
		-- Vanilla-era content, whether or not the client kept the glyph API.
		Glyphs = {}
	end
