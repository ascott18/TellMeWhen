...
--
-- GroupComponent provides a common base for these objects, and it provides a method for registering default group settings. It is an abstract class, and should not be directly instantiated.
--
-- @class file
