...
* You can now Shift-click or Shift+Tab a suggestion in the Name field of a Buff/Debuff (combat ready) icon to insert every spell ID that shares that name (#2473).
